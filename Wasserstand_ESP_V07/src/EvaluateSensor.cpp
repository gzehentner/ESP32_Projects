...
/*================================================================*/
{
  ...
  if (filterCnt >= filterCntMax)
  {
    ...
    if (abs(diffMyValue) > 1)
    { // print on change only (change > 1 to avoid too often change)
...
void calculateWorstCaseAlarmState()
{
  ...
  {
    Serial.print("alarmStateRelais: ");
    Serial.println(alarmStateRelais);
    // Serial.print("AHH: "); Serial.println(val_AHH);
    // Serial.print("AH : "); Serial.println(val_AH);
    // Serial.print("AL : "); Serial.println(val_AL);
    Serial.print("alarmStatePegel: ");
    Serial.println(alarmStateLevel);
    Serial.print("Pegel: ");
